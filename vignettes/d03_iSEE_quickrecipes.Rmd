...
For a general overview of the default `iSEE` panels, we refer to the [overview vignette](iSEE_overview_02.html). 
...
<li>For more information about the different types of panels, see the [overview vignette](iSEE_overview_02.html) or the help pages for the respective panel classes.</li>
</ul>
</details>
