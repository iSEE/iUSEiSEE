...
This vignette consists of a series of (independent) hands-on recipes, aimed at exploring the capabilities of `r Biocpkg("iSEE")` [@Rue-Albrecht2018-isee] both interactively and programmatically.
...
For a general overview of the default `iSEE` panels, we refer to the [overview vignette](d02_iSEE_overview.html). 
...
<li>For more information about the different types of panels, see the [overview vignette](d02_iSEE_overview.html) or the help pages for the respective panel classes.</li>
</ul>
</details>
...
```{r, echo=FALSE}
SCREENSHOT("images/03-recipe_01.png", delay = 20)
```
...
```{r, echo=FALSE}
SCREENSHOT("images/03-recipe_02.png", delay = 20)
```
...
```{r, echo=FALSE}
SCREENSHOT("images/03-recipe_03.png", delay = 20)
```
...
```{r, echo=FALSE}
SCREENSHOT("images/03-recipe_04.png", delay = 20)
```
...
```{r, echo=FALSE}
SCREENSHOT("images/03-recipe_05.png", delay = 20)
```
...
```{r, echo=FALSE}
SCREENSHOT("images/03-recipe_06.png", delay = 20)
```
...
```{r, echo=FALSE}
SCREENSHOT("images/03-recipe_07.png", delay = 20)
```
...
```{r, echo=FALSE}
SCREENSHOT("images/03-recipe_08.png", delay = 20)
```
...
<li>Under `Receive column selection from`, select `Feature assay plot 1`.</li>
<li>In the `ColumnDataPlot` panel, click to expand the `Visual parameters` collapsible box, make sure that the `Color` checkbox is ticked.</li>
...
```{r, echo=FALSE}
SCREENSHOT("images/03-recipe_09.png", delay = 20)
```
...
```{r, echo=FALSE}
SCREENSHOT("images/03-recipe_10.png", delay = 20)
```
...
```{r, echo=FALSE}
SCREENSHOT("images/03-recipe_11.png", delay = 20)
```
